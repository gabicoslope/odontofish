...
Site estático de uma página. Tema "do raso ao fundo do mar": a página escurece
conforme desce, as seções são separadas por ondas e todas as ilustrações são
SVG originais em traço desenhado à mão.
...
- **Contraste AA.** `#1E88C8` só aparece em decoração e texto grande — com
  ...
  mais escuro. Coral vira `#C2410C` quando é texto. Zero violações no axe-core
  (WCAG 2.1 AA + best-practice), no celular e no desktop.
- **Decoração enxuta no celular.** Cerca de 15 elementos decorativos somem
  abaixo de 640 px, incluindo todos os que cairiam sobre texto.
...
FCP 1,1 s · LCP 1,2 s · TBT 0 ms · CLS 0 · Speed Index 1,1 s
```
